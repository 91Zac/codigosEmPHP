...
<body>
        ...
        <?php
            ...
            if ($conexao->connect_error) {
                ...
                <h1 class="w3-center w3-orange w3-round-large w3-margin">Notas de Inglês</h1>
                ...
                <thead>
                ';
                $sql = "SELECT * FROM pwii.alunoConcluinte" ;
                $resultado = $conexao->query($sql);
                if($resultado != null)
                foreach($resultado as $linha) {
                    echo '<tr class="w3-hover-blue">';
                    echo '<td class="w3-violet">'.$linha['idAlunoConcluinte'].'</td>';
