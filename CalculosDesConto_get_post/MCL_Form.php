...
<body>
    ...
    <form class="w3-container" method="post" action="MCL_Action.php">
        ...
        <input class="w3-input w3-border w3-light-grey" name="txt_V_Compra" type="number">

        <label class="w3-text-teal"><b>Escolha a forma de Pagamento:</b></label>

        <select class="w3-input w3-border w3-light-grey"  name = "option_pag">
